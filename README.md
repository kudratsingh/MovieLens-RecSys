...
Still open in Phase 3: per-tenant champion routing, audit retention, dev/staging Compose files,
and the offline routing gap the cold-start cohort found (below). The frontend finish gate passes every
