...
- **Remaining Phase 3 work** is itemised in [`docs/status/phase-3.md`](docs/status/phase-3.md): product track — moderated sessions then `/legacy` retirement, `/me` ownership, N6; platform track — Feast-backed ranker training. Training-time candidate exclusions now match the serving rule.
