...
| 5 — Mixing and re-ranking | **approved** | 2026-09-15 | 0019 | Fixed-budget attributed union first; source-aware ranker second; MMR only after relevance clears the gate. Awaiting owner approval; no implementation or runs authorized. |
