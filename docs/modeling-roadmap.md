...
| 2 — SASRec | in progress — one owner-approved artifact-backed run complete, not promotable | 2026-09-05 | 0016 | Warm recall@500 0.4652 vs protocol-matched item-item 0.3991; exact artifact and evidence retained; rolling/tolerance/latency and paired-ranker gates remain |
