...
| 5 — Mixing and re-ranking | proposed | 2026-09-05 | 0019 | Fixed-budget attributed union first; source-aware ranker second; MMR only after relevance clears the gate. Awaiting owner approval; no implementation or runs authorized. |
