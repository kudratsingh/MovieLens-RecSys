...
| 1 — Two-tower v2 | queued after Phase 3 closeout | 2026-09-03 | — | Repair and measure before moving to the next model; starts with its own ADR proposal |
| 2 — SASRec | deferred | 2026-09-03 | 0015 | Designed, but deferred until Phase 3 closes and two-tower v2 is repaired and measured |
