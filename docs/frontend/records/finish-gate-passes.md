# Movie-discovery frontend: UI finish-gate passes

> **Record.** The four dated passes of the UI finish gate, verbatim, as each was
> written: **7A** (2026-08-21, §1–§9), the **7D cutover re-run** (§10), the
> **frontend sweep** (2026-08-27, §11), and the **Seen re-run** (2026-08-28,
> §12). Not maintained — a later pass is appended rather than folded into an
> earlier one, which is what makes the sequence readable.
>
> **For the current verdict, the criteria table and how to re-run the gate, read
> [`../finish-gate-review.md`](../finish-gate-review.md) instead.** This file is
> the evidence behind it: what was run, what was observed, and what each pass
> found. The running text below still refers to itself as "this document" and
> cross-references its own sections by number; those references are correct
> within this file.
