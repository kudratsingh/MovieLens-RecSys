...
| 0016 | [SASRec for Sequential Retrieval](0016-sasrec-sequential-retrieval.md) | Defines a causal Transformer over ordered positive history, judged against item-item at recall@500 and the unchanged p99 gate; deferred until two-tower v2 is measured. | Deferred | Modeling ladder |
