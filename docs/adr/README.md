...
| 0015 | [SASRec for Sequential Retrieval](0015-sasrec-sequential-retrieval.md) | Defines a causal Transformer over ordered positive history, judged against item-item at recall@500 and the unchanged p99 gate; deferred behind Phase 3 closeout and two-tower v2. | Deferred | Modeling ladder |
